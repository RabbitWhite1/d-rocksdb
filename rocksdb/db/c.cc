...
using ROCKSDB_NAMESPACE::DLRUCacheOptions;
using ROCKSDB_NAMESPACE::DDLRUCacheOptions;
...
using ROCKSDB_NAMESPACE::NewDLRUCache;
using ROCKSDB_NAMESPACE::NewDDLRUCache;
...
struct rocksdb_d_lru_cache_options_t {
  DLRUCacheOptions rep;
};
struct rocksdb_dd_lru_cache_options_t {
  DDLRUCacheOptions rep;
};
...
rocksdb_d_lru_cache_options_t* rocksdb_d_lru_cache_options_create() {
  return new rocksdb_d_lru_cache_options_t;
}

rocksdb_dd_lru_cache_options_t* rocksdb_dd_lru_cache_options_create() {
  return new rocksdb_dd_lru_cache_options_t;
}
...
void rocksdb_d_lru_cache_options_destroy(rocksdb_d_lru_cache_options_t* opt) {
  delete opt;
}

void rocksdb_dd_lru_cache_options_destroy(rocksdb_dd_lru_cache_options_t* opt) {
  delete opt;
}
...
void rocksdb_d_lru_cache_options_set_capacity(
    rocksdb_d_lru_cache_options_t* opt, size_t capacity) {
  opt->rep.capacity = capacity;
}

void rocksdb_dd_lru_cache_options_set_capacity(
    rocksdb_dd_lru_cache_options_t* opt, size_t capacity) {
  opt->rep.capacity = capacity;
}
...
void rocksdb_d_lru_cache_options_set_memory_allocator(
    rocksdb_d_lru_cache_options_t* opt, rocksdb_memory_allocator_t* allocator) {
  opt->rep.memory_allocator = allocator->rep;
}

void rocksdb_dd_lru_cache_options_set_memory_allocator(
    rocksdb_dd_lru_cache_options_t* opt,
...
rocksdb_cache_t* rocksdb_cache_create_d_lru_opts(
    rocksdb_d_lru_cache_options_t* opt) {
  rocksdb_cache_t* c = new rocksdb_cache_t;
  c->rep = NewDLRUCache(opt->rep);
  return c;
}

rocksdb_cache_t* rocksdb_cache_create_dd_lru_opts(
    rocksdb_dd_lru_cache_options_t* opt) {
  rocksdb_cache_t* c = new rocksdb_cache_t;
  c->rep = NewDDLRUCache(opt->rep);
  return c;
}
